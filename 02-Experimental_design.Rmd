...
- Volumetric internal standard added into the final extract to guard against small difference of extract volumes.Use e.g. 4,4'-Dibromooctafluorobiphenyl which should not be in the samples and is stable. <br>
- 
