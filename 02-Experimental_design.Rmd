...
Here, the chemicals database could also be from an external folder or library. This is important if you have a central database for all chemicals of interest such as suspect list, spectral libraries, etc.  
