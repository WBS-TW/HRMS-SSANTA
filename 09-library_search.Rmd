...
## QCxMS (this version superseeds previous QCEIMS)
...
- Cehck PlotMS [online manual](https://xtb-docs.readthedocs.io/en/latest/qcxms_doc/qcxms_plot.html)
...
1. Prepare a file with the _equilibrium structure_ of your desired molecule M.
...
__NOTE__: download the 3D conformer structure in pubchem in sdf format and then convert using openbabel -> tmol. Remove the file extension .tmol to only coord. _Structure needs to be optimized?_
...
Check the status of your QCxMS run by changing to your working directory and typing
```
getres
```
