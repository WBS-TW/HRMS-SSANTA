...
set +o noclobber
```
2.1. Place the executables into your $HOME/bin directory or path. Enable the QCEIMS executables in the path:
...
2.2. Place the .XTBPARAM folder and .mass_raw.arg file into your $HOME directory (these files can appear to be hidden). E.g:
  
```
/home/ORUNET.ORU.SE/twg/QCEIMS
```
